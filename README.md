...
### Chart Review on Synthetic Patient, Bill Moore
<table>
  <tr>
    <td align="center">
      <img src="media/morris_aguilar_bill_chart_review_1.png" style="width:350px; height:auto;"/><br/>
    ...
    <td align="center">
      <img src="media/morris_aguilar_bill_chart_review_2.png" style="width:350px; height:auto;"/><br/>
      <sub>The plan section for all patients is separated by medical problem. For each problems it is broken down into subsections, status, decision making/diagnostic plan, treatment/medication plan, contingency planning, considerations for documentation improvement, and considerations for cost effective care improvement.</sub>
    </td>
    <td align="center">
      <img src="media/morris_aguilar_bill_chart_review_3.png" style="width:350px; height:auto;"/><br/>
